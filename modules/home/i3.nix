  ...
  in rec {
    ...
    in
      lib.mkOptionDefault ({
        ...
        // lib.optionalAttrs nixosConfig.hardware.acpilight.enable {
          # Light control
          "XF86MonBrightnessDown" = "exec ${lib.getExe pkgs.acpilight} -dec 10";
          "XF86MonBrightnessUp" = "exec ${lib.getExe pkgs.acpilight} -inc 10";
        });
